                ...
                <Col xs={12} md={8}>
                    <Card>
                        <Card.Body>
                            ...
                            <Card.Text>
                                Every day I strive to learn and grow, applying a growth mindset to everything that I do. With my unique background, and being a lifelong learner, I am excited to apply myself and bring your organization to new heights. 
                            </Card.Text>
                            <Card.Text>
